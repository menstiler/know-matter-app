...
Student.create(name: "Emi", age: 30, email: "emi@gmail.com", username: "test")
Student.create(name: "Mendel", age: 23, email: "mendel@gmail.com", username: "test2")
...
Teacher.create(name: "Henry", bio: "great teacher", hobby_id: Hobby.first.id, location: "Bushwick", rates: 30, title: "Piano teacher for grades 1-6", username: "test2")
Teacher.create(name: "Amy", bio: "20 years experience as an art teacher", hobby_id: Hobby.last.id, location: "East Village", rates: 40, title: "Learn how to paint in oil like a master!", username: "test3")
